* lwasm drawmaze3.asm -fbasic -odrawmaze3.bas

    org $3f00

SCREENW     equ 32
SCREENH     equ 16
SCREENSIZE  equ (SCREENW*SCREENH)
...
* Hard-coded for now.
MAZEBUFFER rmb SCREENW*PACMAZEH ;32*31
MAZEBUFFEREND
