...
260 WD=128
270 FOR X=SW TO WD-SW STEP 8

274 'LEFT GHOST GOING UP
275 LINE(0,WD-X+SH)-(SW,WD-X+SH),PRESET,BF
280 PUT(0,WD-X)-(SW,WD-X+SH),A0

284 'RIGHT GHOST GOING DOWN
285 LINE(WD,X-SH)-(WD+SW,X+SH-SH),PRESET,BF
290 PUT(WD,X)-(WD+SW,X+SH),A2

294 'BOTTOM GHOST GOING LEFT
295 'LINE(WD-X,WD+SH)-(WD-X+SW,WD+15+SW),PRESET,BF
296 PUT(WD-X,WD)-(WD-X+SW,WD+SH),A4

304 'TOP GHOST GOING RIGHT
305 'LINE(X-SH,0)-(X+7-SH,15),PRESET,BF
310 PUT(X,0)-(X+SW,SH),A6
...
360 ONPD GOTO380,440,500,560
 
370 ' UP
380 ONPF GOTO390,400,410,420
...
1130 PRINT".";
1140 FORZ=L TOL+7:READV:POKEZ,V:NEXT:RETURN
